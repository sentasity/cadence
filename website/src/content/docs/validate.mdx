...
<Quiz
  ...
  answer={0}
  explanation="The walk is strictly prerequisites, then automated, then manual. Prerequisites come first and block the walk until confirmed, so no check runs against an unprepared system."
/>
...
Next: **[Diagnostics: check, find-bugs, explain](/cadence/diagnostics/)**.
