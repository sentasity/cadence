...
Design is the phase that produces the document *you* read and approve. Where brainstorm gave you a short stub, `/c-design` grows it into a full **design folder** written for a human — specifically, a human who will never read the code.
...
Next phase: **[The Plan phase](/cadence/course/plan/)**.
