...
This is the philosophical heart of the phase. When the stub is written, brainstorm **stops** and tells you to run `/c-design` yourself. It never silently rolls forward into writing the full design.
...
Next phase: **[The Design phase](/cadence/course/design/)**.
