...
Cadence is a Claude Code plugin from [Sentasity](https://sentasity.com) that turns "I want to build X" into working, validated software, without asking you to read a single line of code to know it's right. This first lesson gives you the mental model. The next one installs the plugin.
