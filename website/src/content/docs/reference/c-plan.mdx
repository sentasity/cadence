...
Source of truth: `skills/c-plan/SKILL.md`. For the *why* behind this stage, read the [Plan deep dive](/cadence/course/plan/).
...
- **Deep dive:** [The Plan stage](/cadence/course/plan/) for why a separate code-exact plan exists and the linkage mechanism.
