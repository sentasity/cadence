...
Source of truth: `skills/c-plan/SKILL.md`. For the *why* behind this phase, read the [Plan deep dive](/cadence/course/plan/).
...
Use `/c-plan` once a design is approved and you want a precise, executable blueprint before building. It is the third phase, between design and execute. Don't use it to write code or to run anything — it only writes the plan.
...
- **Deep dive:** [The Plan phase](/cadence/course/plan/) for why a separate code-exact plan exists and the linkage mechanism.
