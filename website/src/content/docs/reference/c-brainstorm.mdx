...
Source of truth: `skills/c-brainstorm/SKILL.md`. For the *why* behind this stage, read the [Brainstorm deep dive](/cadence/brainstorm/).
...
- **Deep dive:** [The Brainstorm stage](/cadence/brainstorm/) for the concept and the one-question-at-a-time discipline.
