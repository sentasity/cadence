...
Source of truth: `skills/c-audit/SKILL.md`. For the *why* behind this stage, read the [Audit deep dive](/cadence/audit/).
...
- **Deep dive:** [The Audit stage](/cadence/audit/) for what counts as drift between plan and implementation.
