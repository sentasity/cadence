...
Source of truth: `skills/c-audit/SKILL.md`. For the *why* behind this phase, read the [Audit deep dive](/cadence/course/audit/).
...
- **Deep dive:** [The Audit phase](/cadence/course/audit/) for what counts as drift between plan and implementation.
