...
Hunts for concrete, fixable defects in a doc or in code (each one named with a file-and-line citation, a severity, and a one-line fix direction) so you can see what's actually wrong without reading the code.
