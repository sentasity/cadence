...
- **Configuration:** the [`worktree` section](/cadence/reference/config/#worktree) of the config reference documents `dir`, `integrate`, `merge_lock`, `lock_stale_threshold`, and the five hooks with their execution contract.
