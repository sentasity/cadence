...
Source of truth: `skills/c-design/SKILL.md`. For the *why* behind this stage, read the [Design deep dive](/cadence/course/design/).
...
- **Deep dive:** [The Design stage](/cadence/course/design/) for the artifact, the narrative, and the self-review gate.
