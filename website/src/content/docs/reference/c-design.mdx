...
Source of truth: `skills/c-design/SKILL.md`. For the *why* behind this phase, read the [Design deep dive](/cadence/course/design/).
...
Use `/c-design` once you have an approved-shape stub and want the full, reviewable design before any plan or code. It is the second phase, sitting between brainstorm and plan. Don't use it to write a plan or touch code — those come later.
...
- **Deep dive:** [The Design phase](/cadence/course/design/) for the artifact, the narrative, and the self-review gate.
