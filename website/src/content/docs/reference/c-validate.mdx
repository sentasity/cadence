...
Source of truth: `skills/c-validate/SKILL.md`. For the *why* behind this stage, read the [Validate deep dive](/cadence/validate/).
...
- **Deep dive:** [The Validate stage](/cadence/validate/) for the checklist categories and closing the loop.
